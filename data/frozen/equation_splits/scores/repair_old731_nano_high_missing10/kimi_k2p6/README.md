...
Created: 2026-05-03T17:04:08.857845+00:00

Judge: `accounts/fireworks/models/kimi-k2p6` via `https://api.fireworks.ai/inference/v1`.
Elapsed seconds: 1.9.
...
- n pairs: 10
- mean diff per token (`scaffold_z_predictor - bare_B`): -0.18681588302922655
- stderr: 0.08213176489330894
- positive rate: 0.0
